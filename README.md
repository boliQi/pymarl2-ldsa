...
CUDA_VISIBLE_DEVICES=2 python3 src/main.py --config=qmix_high_sample_efficiency --env-config=sc2 with env_args.map_name=5m_vs_6m
CUDA_VISIBLE_DEVICES=1 python3 src/main.py --config=qmix --env-config=sc2 with env_args.map_name=5m_vs_6m
python main.py --env-config=sc2v2 --config=qmix with env_args.map_name="10gen_terran"
python src/main.py --config=ldsa --env-config=sc2 with env_args.map_name=5m_vs_6m use_wandb=True wandb_group=parallel
```
